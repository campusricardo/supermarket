...
error_reporting(E_ALL);
  require_once('./configs/config_categorias.php');
          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td class="row justify-content-center gap-2 col-10">
                <a class="btn btn-danger" href="./configs/delete/borrar_categorias.php?id=<?= $val['categoria_id'] ?>&req=delete">BORRAR</a>
                <a class="btn btn-primary" href="./configs/update/update_categorias.php?id=<?=$val['categoria_id']?>">Editar</a>
              </td>
            </tr>
      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" >
        <div class="modal-content" >
          ...
          <div class="modal-body" style="background-color: rgb(231, 253, 246);">
            <form class="col d-flex flex-wrap" action="./configs/create/registrar_categoria.php" method="post">
